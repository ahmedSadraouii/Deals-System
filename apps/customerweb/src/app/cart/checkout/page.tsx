...
export default function Page() {
  ...
  const defaultValues: Omit<CheckoutInputModel, 'dateOfBirth'> & {
    email?: string;
    dateOfBirth: ZonedDateTime;
    countryCode: string;
  } = {
    email: 'aldi-deals-test99@turtledev.net',
    firstName: 'Felix',
    lastName: 'Faustusss',
    postalCode: '51545',
    houseNumber: '44',
    street: 'Freiherr-vom-Stein-Straße',
    dateOfBirth: new ZonedDateTime(1997, 6, 26, 'Europe/Berlin', 0),
    city: 'Waldbröl',
    countryCode: 'DE',
  };
  ...
  return (
    <div>
      ...
      <div className="mt-20 grid grid-cols-2 gap-10">
          ...
          <div className="flex flex-col gap-10">
            ...
            <div className="flex flex-col items-center rounded-[20px] bg-neutral-100 p-10">
              <p className="mb-6 border-b border-b-neutral-200 pb-6 text-center text-secondary">
                ...
                kannst du deine bevorzugte Zahlungsmethode auswählen und den
                Kauf abschließen.
              </p>
        ...
        <div>
          <div className="rounded-[20px] bg-neutral-100 p-10">
            <CheckoutCostOverview onCheckout={onClickProceed} />
          </div>
        </div>
      </div>
    </div>
