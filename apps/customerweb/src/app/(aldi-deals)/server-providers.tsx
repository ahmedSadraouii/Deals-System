...
import { getServerCart } from '@/app/(aldi-deals)/cart/get-server-cart';
import { CartContextProvider } from '@/app/(aldi-deals)/contexts/cart/cart-context';
import { FavoriteContextProvider } from '@/app/(aldi-deals)/contexts/favorite/favorite-context';
