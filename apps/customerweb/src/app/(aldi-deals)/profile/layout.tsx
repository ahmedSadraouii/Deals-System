...
import { ProfileDesktopHeader } from '@/app/(aldi-deals)/profile/profile-desktop-header';
import { ProfileMobileHeader } from '@/app/(aldi-deals)/profile/profile-mobile-header';
