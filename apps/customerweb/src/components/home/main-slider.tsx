            ...
            .map((_, index) => (
              <SwiperSlide key={index}>
                <div className="overflow-hidden p-5 ">
                  <div className="mx-auto rounded-3xl bg-neutral-100 px-6 py-6 lg:px-8">
                    <div className="mx-auto grid max-w-2xl grid-cols-1 gap-8 lg:mx-0 lg:max-w-none lg:grid-cols-2">
                      ...
                      <div className="relative">
                        ...
                        <dl className="mt-10 space-y-8 text-base leading-7 text-neutral-600">
                          <div className="relative">
                            <h1 className="text-3xl font-bold">
                              2 Tickets zum Preis von 1
                            </h1>
                            <p className="mt-6 hidden font-extralight leading-8 text-neutral-600 md:block">
