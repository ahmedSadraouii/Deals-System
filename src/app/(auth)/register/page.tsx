    ...
    <>
      <section className="h-full bg-gray-50 px-5 py-28 text-center">
        ...
        <div className="mx-auto w-full sm:max-w-6xl">
          <Button
            type="button"
            className="mt-5 rounded-full border-1 border-black bg-transparent px-5 py-7 text-center text-sm font-medium text-black hover:bg-primary-700 focus:outline-none focus:ring-4 focus:ring-primary-300"
          >
            <Image
